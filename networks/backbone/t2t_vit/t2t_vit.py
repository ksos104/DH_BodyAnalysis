...
class T2T_module(nn.Module):
    ...
    """
    def __init__(self, img_size=224, tokens_type='performer', in_chans=3, embed_dim=768, token_dim=64, return_interm=False):
        super().__init__()
    ...
    def forward(self, x):
        ...
        if self.return_interm:
            x_interm = self.project(x)
            x_list.append(x_interm)
