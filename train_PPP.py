...
from datasets.datasets_pascal15000 import PascalPartSegmentation
...
def get_arguments():
    ...
    # Data Preference
    parser.add_argument("--data-dir", type=str, default='../data/PPP')
    ...
    parser.add_argument("--schp-start", type=int, default=300, help='schp start epoch')
...
def main():
    ...
    train_dataset = PascalPartSegmentation(root=args.data_dir, split='train', crop_size=input_size, # [512,512]
                                       scale_factor=0.25,
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        print('epoch = {} of {} completed using {} s'.format(epoch+1, args.epochs,
